...
public class StartMenuManager : MonoBehaviour
{
    ...
    private int minMaxPlayers = 2; // Set the minimum and maximum number of players
    ...
    void StartHost()
    {
        if (networkManager != null)
        {
            ...
            waitingForClientCanvas.SetActive(true);
    ...
    void OnClientConnected(ulong clientId)
    {
        ...
        {
            if (NetworkManager.Singleton.ConnectedClients.Count > minMaxPlayers)
            {
